...
The drawing logic lives in tools/pinout/: nucleo144.py and feather.py
are the two form-factor templates (generic drawing primitives shared
by every board built on that outline-- Nucleo-144 and Adafruit
Feather, respectively); tools/pinout/boards/*.py hold each board's
data-- pin tables, silk names, fixture positions-- plus any
